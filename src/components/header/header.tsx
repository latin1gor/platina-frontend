...
const Header = ({ isAuth }: HeaderProps) => {
  ...
  return (
    <div
      className={
        "flex justify-between items-center px-5 h-14 bg-transparent border-b border-stone-900 backdrop-blur-lg text-sm text-zinc-400 z-40 fixed top-0 select-none w-full max-w-screen-2xl m-auto"
      }
    >
      ...
      {isAuth ? (
        <div className={"flex items-center"}>
          <Button
            className={
              "relative mr-5 p-1.5 h-10 w-10 bg-gradient hover:shadow-2xl hover:shadow-purple-500"
            }
          >
            <ShoppingCart />
